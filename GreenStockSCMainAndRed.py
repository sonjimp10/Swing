...
# ----------------- CONFIG -----------------
UNIVERSE = Path(r"C:\Users\JMuk\Py Scripts Old\Swing\SmallCap.csv")
DATA_DIR = Path(r"C:\Users\JMuk\Py Scripts Old\Swing\ALPACA_SC_DAILY_DATA")
OUTPUT_CSV = Path(r"C:\Users\JMuk\Py Scripts Old\Swing\outputs\lastN_green_after_red_volume_screen_SC.csv")
