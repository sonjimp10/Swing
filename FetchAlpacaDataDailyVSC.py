...
def main():
    parser = argparse.ArgumentParser(description="Fetch Alpaca DAILY bars -> ALPACA_VSC_DAILY_DATA/")
    parser.add_argument("--input", default="VerySmallCap.csv", help="CSV/Excel with tickers")
    parser.add_argument("--sheet", default=None, help="Sheet name if Excel")
    parser.add_argument("--outdir", default="ALPACA_VSC_DAILY_DATA", help="Output folder")
